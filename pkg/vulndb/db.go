...
import (
	...
	"github.com/sizocompany/sizo-db/pkg/metadata"
	"github.com/sizocompany/sizo-db/pkg/types"
	"github.com/sizocompany/sizo-db/pkg/vulnsrc"
	"github.com/sizocompany/sizo-db/pkg/vulnsrc/vulnerability"
)
...
type Option func(*SizoDB)

func WithClock(clock clock.Clock) Option {
	return func(core *SizoDB) {
		core.clock = clock
	}
}
...
func New(cacheDir string, updateInterval time.Duration, opts ...Option) *SizoDB {
	// Initialize map
	vulnSrcs := map[types.SourceID]vulnsrc.VulnSrc{}
...
func (t SizoDB) Insert(targets []string) error {
...
func (t SizoDB) Build(targets []string) error {
...
func (t SizoDB) vulnSrc(target string) (vulnsrc.VulnSrc, bool) {
