...
import (
	...
	"github.com/sizocompany/sizo-db/pkg/utils"
	ustrings "github.com/sizocompany/sizo-db/pkg/utils/strings"
...
type PutInput struct {
	...
	OVAL       OracleOVAL                         // for extensibility, not used in sizo-db
}
...
type VulnSrc struct {
	DB // Those who want to customize Sizo DB can override put/get methods.
}
...
// It is exported for those who want to customize sizo-db.
